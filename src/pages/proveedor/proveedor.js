...
export default function Proveedor() {
  ...
  const [fetch, refetch] = useGet("/proveedor");
  const [put] = usePut("/proveedor");
  const [del] = useDelete("/proveedor");
  const [post] = usePost("/proveedor");
            ...
            <Paper className={classes.newRow}>
              <Grid container spacing={3}>
                <Paper className={classes.newRow1}>
                  <Grid item xs={12}>
                    <Typography variant="h4">Datos del Provedor</Typography>
                  </Grid>
                </Paper>
                <Grid item xs={12}>
                  <TextField
